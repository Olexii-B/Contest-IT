...
// Функція для збору вибраних класів
function getSelectedClasses() {
  ...
  return selectedClasses; // Повертає масив значень вибраного класу
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Додати обробник подій для відправлення форми
  form.addEventListener('submit', function (event) {
    event.preventDefault();

    // Отримати всі дані форми
