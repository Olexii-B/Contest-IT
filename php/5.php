...
"CREATE TABLE IF NOT EXISTS unique_notifications (
        id INT AUTO_INCREMENT PRIMARY KEY,
        content TEXT NOT NULL,
        type ENUM('info', 'success', 'warning', 'error') DEFAULT 'info',
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        UNIQUE KEY unique_content (content, type)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
...
"CREATE TABLE IF NOT EXISTS notifications (
        ...
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        UNIQUE KEY unique_notification (user_id, notification_id),
        FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
        FOREIGN KEY (notification_id) REFERENCES unique_notifications(id) ON DELETE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4"
];
